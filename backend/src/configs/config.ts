export const Config: any = {
    ...
    RATELIMITS_TOTALDAILYLIMIT: process.env.SECRET_RATELIMITS_TOTALDAILYLIMIT || null,
    DEMOLIMITS_TOTALDAILYLIMIT: process.env.SECRET_DEMOLIMITS_TOTALDAILYLIMIT || null,
