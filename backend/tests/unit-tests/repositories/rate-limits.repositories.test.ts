...
describe('Route: /meta/demo', () => {
    ...
    describe('Database tests table <demo_limits>, priority: count', () => {
    ...
    describe('Database tests table <demo_limits>, priority: create', () => {
    ...
    describe('Database tests table <demo_limits>, priority: update', () => {
        ...
        describe('Testing valid fn calls', () => {
            ...
            test('Return data of changed entry by valid day', async () => {
            ...
            test('Return null for non-existing entry by invalid day', async () => {
