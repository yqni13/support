...
describe('Model tests, class: <clients>, priority: generateClientsObj', () => {
    ...
    describe('Testing valid fn calls', () => {
        ...
        test('Generate new clients object + raw key, entity: <Clients>', () => {
            ...
            const mockTimestamp = '2025-11-17T18:48:00.000Z';
            ...
            jest.spyOn(clientsModel, "generateApiKeyObj").mockReturnValue(mockApiKeyObj);
            jest.spyOn(Utils, "getTimestampUTC").mockReturnValue(mockTimestamp);

            const testFn = clientsModel.generateClientsObj(mockParam_dto);
