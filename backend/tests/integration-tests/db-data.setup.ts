...
export class DBTestData {
    ...
    getTicketsInsertSql(): { sql: string, values: any[] } {
        ...
        `;
        const values = ['ae9550fc-16fd-4e9a-8ab5-d6ab55b84cb4', '9e024539-32e8-4317-8007-84a3956e6b57', '87e4d6e3-d678-4de0-8806-e89135cbd38c', TicketStatus.ACTIVE, 'test-message', ['test/path/num0', 'test/path/num1'], null, '2025-01-01T14:00:04.000', '2025-01-01T14:00:04.000'];
        return { sql: sql, values: values };
    }
}